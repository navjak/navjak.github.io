      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-domain-adaptive-residual-vae",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/DA_residualVAE/";
            },},{id: "projects-balle-2017-factorized-prior",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/balle2017/";
            },},{id: "projects-balle-2018-scale-hyperprior",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/balle2018/";
            },},{id: "projects-balle-2018-transformer-hyp",
          title: 'Balle(2018) + transformer-hyp',
          description: "Extension of Ballé (2018) Learned Img Compression model using a Transformer-based hyperprior",
          section: "Projects",handler: () => {
              window.location.href = "/projects/balle2018_transformer/";
            },},{id: "projects-base-transformer-nlp",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/base_transformer_nlp/";
            },},{id: "projects-cineflix",
          title: 'CineFlix',
          description: "Content-based Movie Recommendation System, utilizing data scraped from Wikipedia articles and tables to suggest films based on user preferences.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/cineflix_project/";
            },},{id: "projects-domain-adaptation-and-zero-shot-evaluation-of-clip",
          title: 'Domain Adaptation and Zero-Shot Evaluation of CLIP',
          description: "Building a pipeline to evaluate CLIP’s zero-shot performance across diverse domains and extend it with LoRA-based adaptation for satellite images.",
          section: "Projects",handler: () => {
              window.location.href = "/projects/clip_eval,md/";
            },},{id: "projects-cross-domain-neural-models-for-learned-compression",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/projects/vit_2021/";
            },},{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6E%61%76%64%65%65%70%6A%61%6B%68%61%72%33%30@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/navjak", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/navdeep-jakhar-6b8ab8254", "_blank");
        },
      },{
      id: 'light-theme',
